package com.example.tensorflowlite_mnist_recognition;
...
public class Classifier {
    ...
    public Classifier(Activity activity) throws IOException {
        ...
        //al implementar el numero de canales no clasifica bien
        //mImageData = ByteBuffer.allocateDirect(4 * BATCH_SIZE * IMG_HEIGHT * IMG_WIDTH * NUM_CHANNEL);
        //se dejo si numero de canales y logra clasificar bien.
        mImageData = ByteBuffer.allocateDirect(4 * BATCH_SIZE * IMG_HEIGHT * IMG_WIDTH);
